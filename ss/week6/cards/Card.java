...
public class Card implements Serializable
{
	...
	public void write(PrintWriter message){
	...
	public static Card read(BufferedReader in) throws EOFException, IOException {
		try {
			...
			String cardIn = in.readLine();
			String[] cardInList = cardIn.split(" ");

			if (cardInList.length != 2) return null;

			String suit = cardInList[0];
			String rank = cardInList[1];
	...
	public static Card read(ObjectInput in) throws EOFException, IOException, ClassNotFoundException {
	...
	public static void main(String[] args) {
		...
		try {
			...
			new Card('H', 'Q').write(out);
			new Card('C', 'J').write(out);
