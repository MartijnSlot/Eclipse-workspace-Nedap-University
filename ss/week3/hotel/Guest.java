...
public class Guest {
	 ...
	 * 
	 * @return the Room of this <code>Guest</code>; <code>null</code> if this
	 *         <code>Guest</code> is not currently renting
	 */
	public Room getRoom() {
		return this.room;
	}
	...
	/**
	 * Rents a Room to this Guest. This is only possible if this Guest does not
	 * already have a Room and the Room to be assigned is not already rented.
	...
	/**
	 * Sets the Room of this <code>Guest</code> to null. Also resets the
	 * Guest-reference of the (current) <code>Room</code>.
	 */
